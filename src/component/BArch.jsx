...
function BArch() {
  ...
  const colleges1 = [
    ...
    },
    {
      ...
      courses: ["B.Arch", "Interior Design"],
      featured: true,
    },
  ];

  const colleges = [
    { name: "SPA Delhi", country: "India", fees: "₹2.8 Lakh / year" },
    { name: "CEPT University", country: "India", fees: "₹3.2 Lakh / year" },
    {
      name: "Chandigarh University",
      country: "India",
      fees: "₹2.5 Lakh / year",
    ...
    <>
      ...
      <section className="bg-gradient-to-r from-purple-900 to-indigo-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-6">
          <h1 className="text-4xl sm:text-5xl font-bold">
            B.Arch Admission in India
          </h1>
          <p className="mt-4 text-lg text-white/80 max-w-2xl">
            Complete guidance for Bachelor of Architecture admissions through
            NATA & JEE Paper 2.
          </p>
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-10 px-4">
          <div>
            ...
            <p className="text-gray-600 mt-4">
              B.Arch is a 5-year undergraduate program focused on architectural
              design, building construction, planning, and sustainable
              development. It combines creativity with technical skills.
            </p>
            <button className="mt-6 bg-green-500 text-white px-6 py-3 rounded-full">
              Explore More <FaChevronRight className="inline ml-2" />
            </button>
          </div>
          <img src="/image/admission.jpg" alt="BArch Admission" />
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-4 gap-6">
          <div className="bg-white p-6 rounded-xl text-center shadow">
            <h4 className="font-bold text-purple-700">Duration</h4>
            <p className="mt-2">5 Years</p>
          </div>
          <div className="bg-white p-6 rounded-xl text-center shadow">
            <h4 className="font-bold text-purple-700">Eligibility</h4>
            <p className="mt-2">12th with PCM</p>
          </div>
          <div className="bg-white p-6 rounded-xl text-center shadow">
            <h4 className="font-bold text-purple-700">Entrance Exams</h4>
            <p className="mt-2">NATA, JEE Paper 2</p>
          </div>
          <div className="bg-white p-6 rounded-xl text-center shadow">
            <h4 className="font-bold text-purple-700">Average Salary</h4>
            <p className="mt-2">₹4 – 10 LPA</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-20">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold">Top B.Arch Colleges</h2>
        </div>
      ...
      <section className="bg-purple-50 py-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <input
              name="exam"
              placeholder="NATA Score / JEE Rank"
              onChange={handleChange}
              className="w-full border p-3 rounded"
            />
            <button className="w-full bg-purple-700 text-white py-3 rounded-lg">
              Submit
            </button>
          </form>
        </div>
