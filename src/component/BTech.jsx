    ...
    <>
      <section className="relative bg-gradient-to-r from-indigo-900 to-indigo-700 text-white">
        <div className="max-w-7xl mx-auto px-6 py-20">
          ...
          <p className="mt-4 text-lg text-white/80 max-w-2xl">
            Complete guidance for BTech admissions through JEE Main, JEE
            Advanced & State Counselling.
          </p>
      ...
      <section className="py-20">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-10 px-4">
          <div className="space-y-5">
            ...
            <h2 className="text-4xl font-bold">Engineering Your Success</h2>

            <p className="text-lg text-gray-600">
              We help students secure BTech admission in top IITs, NITs, and
              private universities with expert counselling, proper guidance, and
      ...
      <section className="py-16 bg-gray-50">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6 px-4">
          <div
            className="flex flex-col gap-4 p-6 bg-white shadow-lg hover:shadow-xl 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center justify-center gap-5 p-4 sm:px-6 md:px-12 lg:px-24">
          <div className="flex flex-col rounded-3xl  border border-gray-300 overflow-hidden    w-full">
            ...
            <div className="p-6 flex flex-col items-start gap-2">
              ...
              <p>
                Discover B.Tech programs, eligibility criteria, and future
          ...
          <div className="flex flex-col rounded-3xl  border border-gray-300 overflow-hidden    w-full">
            ...
            <div className="p-6 flex flex-col items-start gap-2">
              ...
              <p>
                Join hands-on sessions on cutting-edge technologies and
      ...
      <section className="bg-gradient-to-br from-[#eef2ff] to-[#c7d2fe] py-20 px-4">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col justify-center gap-4">
            <h2 className="text-3xl font-bold">Shaping Engineering Careers</h2>

            <p className="text-gray-700">
              Trusted counselling platform helping students secure BTech
              admissions in top engineering colleges.
            </p>
          </div>
        </div>
      </section>
