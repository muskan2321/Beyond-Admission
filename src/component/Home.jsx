...
<div className="relative w-full min-h-[calc(100vh-80px)] overflow-hidden">
  ...
  <Slider {...settings} className="h-full">
    {["/image/college-3.jpg","/image/college-4.jpg","/image/college-5.jpg"].map((img,i)=>(
      <div
        key={i}
  ...
  <div
    ...
    "
  >
    <div className="w-full max-w-3xl px-4 sm:px-6 pb-20">
      ...
      <h1 className="font-display text-xl font-bold leading-tight sm:text-5xl lg:text-6xl">
        ...
        <span className="text-amber-500">Admissions in India & Abroad</span>
      </h1>
      ...
      <div className="mt-10 flex flex-wrap gap-4">
        <a className="inline-flex h-12 items-center justify-center gap-2 rounded-md bg-amber-500 px-8">
          Apply Now <FaArrowRight />
        </a>
        <a className="inline-flex h-12 items-center justify-center rounded-md border px-8">
          Free Counseling
        </a>
        <a className="inline-flex h-12 items-center justify-center px-8">
          📞 Call Now
        </a>
      </div>
 ...
 <section className="py-16 bg-gradient-to-b from-gray-50 to-white">
  <div className="max-w-7xl mx-auto px-4 text-center relative">
    ...
    <button
      ...
      hover:scale-110 transition rounded-full p-3 z-10"
    >
    ...
    >
      {states.map((state, i) => (
        <li key={i} className="min-w-[160px]">
          <a
            href={state.link}
            target="_blank"
            rel="noreferrer"
          ...
          >
            ...
            bg-gradient-to-tr from-indigo-50 to-sky-50 
            rounded-xl mb-3">
              <img
                src={state.img}
                alt={state.name}
