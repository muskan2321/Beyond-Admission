...
export default function MBACanada() {
  ...
  `}</style>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              Study MBA in <span className="text-blue-600">Canada</span> for
              Indian Students
            </h2>

            <p className="mt-4 text-gray-600 text-lg">
              Experience world-class business education, global exposure, and
              excellent career opportunities in Canada.
            </p>
          </div>
            ...
            <div>
              <div className="bg-white rounded-3xl shadow-xl p-10 border border-gray-100">
                <h3 className="text-2xl font-bold mb-4 text-gray-900">
                  Why Choose MBA In Canada?
                </h3>

                <p className="text-gray-600 leading-relaxed">
                  Canada is one of the fastest-growing destinations for MBA
                  studies, offering globally recognized business schools,
                  affordable education, and strong post-study work
                  opportunities.
                </p>

                <p className="mt-4 text-gray-600 leading-relaxed">
                  With a welcoming environment and excellent quality of life,
                  Canada provides Indian students the perfect balance of
              ...
              <div className="mt-8 grid grid-cols-2 gap-4">
                {[
                  ...
                  "Affordable tuition compared to USA",
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              Why Study MBA in <span className="text-blue-600">Canada</span>
            </h2>

            <p className="mt-6 text-lg text-gray-600">
              Canada offers high-quality MBA programs with affordable fees and
              strong career opportunities, making it a popular choice among
              Indian students.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "MBA graduates in Canada enjoy excellent job opportunities with high demand across industries.",
              },
              {
                icon: "💰",
                title: "Affordable Compared to USA",
                desc: "Study at lower tuition costs while still getting world-class education and exposure.",
              },
              {
                icon: "🌍",
                title: "Global Exposure",
                desc: "Work and study in a multicultural environment with international business opportunities.",
              },
              {
                icon: "🏡",
                title: "PR Opportunities",
                desc: "Canada offers easy pathways to permanent residency after completing your MBA.",
              },
            ].map((item, i) => (
              <div
                key={i}
                className="group relative p-[2px] rounded-3xl bg-gradient-to-br from-blue-500 to-indigo-500 shadow-lg hover:shadow-2xl transition duration-500"
              >
                <div className="h-full bg-white rounded-3xl p-8 text-center hover:-translate-y-2 transition duration-500">
                  {/* Icon */}
                  ...
                  {/* Hover Glow */}
                  <div className="absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 bg-gradient-to-br from-blue-100/40 to-indigo-100/40 transition duration-500"></div>
                </div>
              </div>
            ))}
          </div>
      ...
      <section
        id="Popular Courses"
        className="pt-10 pb-20 bg-gradient-to-b from-white via-blue-50 to-white relative overflow-hidden"
      >
        {/* Background Glow */}
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {[
              ...
              { icon: "🌐", title: "International Business" },
              { icon: "🚀", title: "Entrepreneurship" },
            ].map((item, i) => (
              <div
                key={i}
                className="group text-center p-6 rounded-2xl bg-white/80 backdrop-blur-md border border-gray-200 hover:border-blue-500 hover:shadow-xl transition duration-300"
              >
                {/* Icon */}
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              Top Universities in Canada and Their{" "}
              <span className="bg-blue-600 bg-clip-text text-transparent">
                Fees
              </span>
            </h2>
            <p className="mt-4 text-gray-600 text-lg">
              Explore top MBA universities in Canada with tuition fees.
            </p>
          </div>
      ...
      <section
        id="mba-types-canada"
        className="pt-24 pb-28 bg-gradient-to-b from-white via-blue-50 to-white relative overflow-hidden"
      >
        {/* Background Glow */}
        <div className="absolute -top-20 -left-20 w-80 h-80 bg-blue-300/20 rounded-full blur-3xl"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="mt-4 text-gray-600 text-lg">
              Choose the MBA program that best fits your career goals and
              lifestyle.
            </p>
          </div>
            ...
            {[
              {
                icon: "🎓",
                title: "Full-Time MBA",
                desc: "A 1–2 year intensive program ideal for students looking for complete immersion and career transformation.",
              },
              {
                icon: "🚀",
                title: "Executive MBA",
                desc: "Designed for experienced professionals aiming to enhance leadership skills while continuing their careers.",
              },
              {
                icon: "💼",
                title: "Part-Time MBA",
                desc: "Perfect for working professionals who want to study while maintaining their current job.",
              },
              {
                icon: "💻",
                title: "Online MBA",
                desc: "Flexible learning option that allows you to study from anywhere with minimal disruption.",
              },
            ].map((item, i) => (
              <div
                key={i}
                className="group relative p-[2px] rounded-3xl bg-gradient-to-br from-blue-500 to-indigo-500 shadow-lg hover:shadow-2xl transition duration-500"
              >
                <div className="bg-white rounded-3xl p-8 text-center h-full hover:-translate-y-2 transition duration-500">
                  {/* Icon */}
                  ...
                  {/* Glow Effect */}
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 bg-gradient-to-br from-blue-100/40 to-indigo-100/40 rounded-3xl transition duration-500"></div>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="relative pt-6 pb-20 bg-gradient-to-b from-white via-blue-50 to-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              Intakes for MBA in <span className="text-blue-600">Canada</span>
            </h2>

            <p className="mt-6 text-lg text-gray-600">
              Canadian universities offer limited intakes for MBA programs.
            </p>
          </div>
          ...
          <div className="mt-20 max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="group relative bg-white rounded-3xl p-8 shadow-xl border border-indigo-100 hover:shadow-2xl transition duration-300">
                ...
                <ul className="space-y-3 text-gray-700 text-sm">
                  <li>✔ Applications Open: May – Aug</li>
                  <li>✔ Deadlines: Aug – Sep</li>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-3xl p-12 shadow-2xl text-center text-white relative overflow-hidden">
            ...
            <p className="mt-6 text-lg opacity-90 max-w-3xl mx-auto">
              To apply for MBA in Canada, students must meet the following
              requirements:
            </p>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              Cost of MBA in <span className="text-blue-600">Canada</span>
            </h2>
          ...
          <div className="mt-20 grid lg:grid-cols-2 gap-12">
            ...
            <div className="group relative p-10 rounded-3xl bg-white/70 backdrop-blur-xl border border-blue-200 shadow-xl hover:shadow-2xl transition duration-500 overflow-hidden">
              ...
              <div className="relative bg-white/90 rounded-3xl p-8 z-10">
                ...
                <div className="relative p-6 rounded-xl bg-gradient-to-br from-blue-50 to-white shadow-md text-center">
                  <p className="text-3xl font-bold text-blue-600">
                    CAD 30,000 – CAD 70,000
                  </p>
                  <p className="text-gray-500 text-sm mt-1">total program</p>
                </div>
              </div>
            </div>
      ...
      <section className="pt-10 pb-20 bg-gradient-to-b from-white via-blue-50 to-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-gray-600 text-lg">
              Estimated expenses for international students in the MBA in Canada
            </p>
          </div>
            ...
            {[
              {
                ...
                extra: [
                  ...
                  "Depends upon the study in MBA in Canada course selected",
                ],
              },
              {
                title: "Accommodation",
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-6 text-lg text-gray-600">
              Canada offers excellent career opportunities across top global
              companies.
            </p>
          </div>
          ...
          <div className="mt-16">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8 items-center">
              {[
                ...
                { name: "KPMG", logo: "/image/kpmg.png" },
                { name: "PwC", logo: "/image/pwc.png" },
                { name: "BMO", logo: "/image/bmo.png" },
              ].map((company, i) => (
                <div
                  key={i}
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-6 text-lg text-gray-600">
              Canada provides flexible work options during study and strong
          ...
          bg-gradient-to-br from-blue-100/40 via-indigo-100/20 to-sky-100/30"
            ...
            group-hover:scale-110 transition"
                  ...
                  <ul className="mt-6 text-gray-600 space-y-3">
                    <li>● Part-time work allowed</li>
                    <li>● Up to 20 hours/week (during semester)</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          bg-gradient-to-br from-indigo-100/40 via-blue-100/20 to-purple-100/30"
            ...
            group-hover:scale-110 transition"
                  ...
                  <ul className="mt-6 text-gray-600 space-y-3">
                    ...
                    <li>● Up to 3 years work permit</li>
                    <li>● Opportunity for PR pathways</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="mt-20 relative">
            ...
            <div className="grid md:grid-cols-4 gap-10 text-center relative z-10">
              {[
                { icon: "🎓", title: "Study MBA in Canada" },
                { icon: "💼", title: "Part-Time Work" },
                { icon: "🚀", title: "PGWP / Full-Time Job" },
                { icon: "🌟", title: "Career Growth & PR" },
              ].map((step, i) => (
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-6 text-lg text-gray-600">
              Students admitted to Canadian universities must apply for a Study
              Permit.
            </p>
          </div>
          ...
          <div className="relative mt-20">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8 relative z-10">
              {[
                "Receive admission from a Canadian university",
                "Get Letter of Acceptance (LOA)",
                "Prepare financial documents & proof of funds",
                "Apply for Study Permit online",
                "Biometrics & visa approval",
              ].map((step, i) => (
                <div
                  key={i}
          ...
          <div className="mt-20 relative bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 text-white rounded-3xl p-12 text-center shadow-2xl overflow-hidden">
            ...
            <div className="relative z-10">
              <p className="text-lg max-w-3xl mx-auto">
                Ensure proper documentation, financial proof, and timely
                application to increase your visa approval chances.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="relative max-w-5xl mx-auto px-6">
          ...
          <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl p-12 md:p-16 text-center shadow-2xl">
            <h2 className="text-4xl md:text-5xl font-bold leading-tight">
              Start Your MBA Journey in Canada
            </h2>

            <p className="mt-6 text-lg opacity-90">
              Planning to pursue an MBA in Canada? Get expert guidance on top
              universities, admissions, and career opportunities.
            </p>

            <p className="mt-4 text-lg opacity-90">
              Our counsellors will help you with profile evaluation,
              applications, scholarships, and visa process — all in one place.
            </p>
