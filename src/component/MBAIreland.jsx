...
export default function MBAIreland() {
        ...
        <div className="relative max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center z-10">
          ...
          <div>
            ...
            <p className="mt-6 text-lg md:text-xl text-white/80 max-w-xl">
              Industry-focused programs & strong global connections
            </p>

            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              <Link to="/contact">
                <button className="px-8 py-4 bg-gradient-to-r from-blue-500 to-emerald-600 text-white rounded-full font-semibold shadow-xl hover:scale-105 transition">
                  Apply Now
                </button>
              </Link>
  ...
  `}</style>
      ...
      <section className="relative pt-12 pb-24 bg-gradient-to-b from-white via-blue-50 to-white overflow-hidden">
        ...
        <div className="absolute top-40 -right-40 w-[600px] h-[600px] bg-emerald-400/30 rounded-full blur-[130px] animate-float delay-2000"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              Study MBA in <span className="text-blue-600">Ireland</span> for
              Indian Students
            </h2>

            <p className="mt-4 text-gray-600 text-lg">
              Discover industry-focused education, strong job market, and
              excellent career opportunities in Ireland.
            </p>
          </div>
            ...
            <div>
              <div className="bg-white rounded-3xl shadow-xl p-10 border border-gray-100">
                <h3 className="text-2xl font-bold mb-4 text-gray-900">
                  Why Choose MBA In Ireland?
                </h3>

                <p className="text-gray-600 leading-relaxed">
                  Ireland is one of the most popular destinations for MBA
                  studies due to its industry-focused programs, strong economy,
                  and globally recognized universities.
                </p>

                <p className="mt-4 text-gray-600 leading-relaxed">
                  With strong connections to global companies in technology and
                  finance, Ireland offers excellent career opportunities for
              ...
              <div className="mt-8 grid grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={index}
                    className="flex items-center gap-2 bg-yellow-500 hover:bg-blue-100 transition rounded-xl p-3 text-m font-medium text-black hover:text-black"
                  >
      ...
      >
        ...
        <div className="absolute top-40 -right-40 w-[600px] h-[600px] bg-emerald-400/30 blur-[130px] rounded-full animate-float delay-2000"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              Why Study MBA in <span className="text-blue-600">Ireland</span>
            </h2>

            <p className="mt-6 text-lg text-gray-600">
              Ireland offers industry-focused MBA programs with strong
              connections to global companies, especially in technology and
              finance.
            </p>
          </div>
          ...
          <div className="mt-20 grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="group relative p-8 rounded-3xl bg-white/90 backdrop-blur-md border shadow-md hover:shadow-2xl hover:-translate-y-3 transition duration-300 overflow-hidden">
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition duration-500 bg-gradient-to-br from-blue-400/20 via-emerald-400/20 to-blue-400/20"></div>
              <div className="relative z-10">
                ...
                <p className="mt-3 text-gray-600">
                  Excellent career opportunities with global companies.
                </p>
              </div>
            </div>
            ...
            <div className="group relative p-8 rounded-3xl bg-white/90 backdrop-blur-md border shadow-md hover:shadow-2xl hover:-translate-y-3 transition duration-300 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-3 text-gray-600">
                  Access to opportunities across Europe and beyond.
                </p>
              </div>
            </div>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          <h2 className="text-4xl font-bold text-center mb-6">
            Popular MBA Specializations in Ireland
          </h2>
          <p className="text-center text-gray-600 mb-16">
            Choose from diverse specializations aligned with Ireland's strong
            industry sectors.
          </p>
      ...
      >
        ...
        <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-emerald-300/30 blur-[120px] rounded-full animate-pulse"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="relative rounded-3xl p-[2px] bg-gradient-to-r from-blue-500 via-emerald-500 to-blue-500 shadow-2xl">
            <div className="rounded-3xl overflow-hidden backdrop-blur-xl bg-white/80">
              ...
              {[
                { name: "Trinity College Dublin", fees: "€25,000 – €35,000" },
                {
                  name: "University College Dublin",
                  fees: "€24,000 – €34,000",
                },
                { name: "Dublin City University", fees: "€20,000 – €30,000" },
                {
                ...
                <div
                  key={i}
                  className="grid grid-cols-2 items-center border-t border-gray-100 hover:bg-gradient-to-r hover:from-blue-50 hover:to-emerald-50 transition duration-300 group"
                >
      ...
      >
        ...
        <div className="absolute bottom-0 right-0 w-80 h-80 bg-emerald-200/30 blur-3xl rounded-full"></div>

        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              Intakes for MBA in <span className="text-blue-600">Ireland</span>
            </h2>
            <p className="mt-6 text-lg text-gray-600">
              Irish universities offer two main admission intakes.
            </p>
          </div>
          ...
          <div className="mt-20 max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8">
              <div className="group relative bg-white rounded-3xl p-8 shadow-xl border border-blue-100 hover:shadow-2xl transition duration-300">
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-600 to-emerald-600 rounded-t-3xl"></div>
              ...
              <div className="group relative bg-white rounded-3xl p-8 shadow-xl border border-emerald-100 hover:shadow-2xl transition duration-300">
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-emerald-600 to-blue-600 rounded-t-3xl"></div>
                <h4 className="text-xl font-semibold text-emerald-700 mb-6">
                  🌸 January Intake (Limited)
                </h4>
                <ul className="space-y-3 text-gray-700">
                  <li>✔ January (Limited universities)</li>
              ...
              return (
                ...
                >
                  <div className="w-1/2 px-6">
                    <div
                      className={`rounded-xl px-6 py-5 text-white shadow-xl ${index % 3 === 0 ? "bg-gradient-to-r from-blue-400 to-blue-600" : index % 3 === 1 ? "bg-gradient-to-r from-blue-600 to-emerald-600" : "bg-gradient-to-r from-emerald-700 to-blue-800"}`}
                    >
      ...
      >
        <div className="max-w-6xl mx-auto px-6">
          <div className="bg-gradient-to-r from-blue-600 to-emerald-700 rounded-3xl p-12 shadow-2xl text-center text-white relative overflow-hidden">
            <div className="absolute -top-20 -left-20 w-80 h-80 bg-white/10 rounded-full blur-3xl"></div>
            <div className="absolute -bottom-20 -right-20 w-80 h-80 bg-white/10 rounded-full blur-3xl"></div>

            <h2 className="text-4xl md:text-5xl font-bold">
              Eligibility Criteria for MBA in Ireland
            </h2>
            <p className="mt-6 text-lg opacity-90 max-w-3xl mx-auto">
              To apply for MBA in Ireland, students must meet the following
              requirements:
            </p>
      ...
      >
        ...
        <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-emerald-400/30 blur-[120px] rounded-full animate-float delay-2000"></div>

        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              Cost of MBA in <span className="text-blue-600">Ireland</span>
            </h2>
            <p className="mt-6 text-lg text-gray-600">
          ...
          <div className="mt-20 grid lg:grid-cols-2 gap-12">
            ...
            <div className="group relative p-10 rounded-3xl bg-white/70 backdrop-blur-xl border border-emerald-200 shadow-xl hover:shadow-2xl transition duration-500 overflow-hidden">
              <div className="relative bg-white/90 rounded-3xl p-8 z-10">
      ...
      >
        ...
        <div className="absolute bottom-0 right-0 w-80 h-80 bg-emerald-300/20 blur-3xl rounded-full"></div>
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          ...
          <div className="space-y-10">
            {[
              ...
              >
                <div className="w-14 h-14 flex items-center justify-center rounded-xl bg-gradient-to-r from-blue-500 to-emerald-600 text-white text-2xl shadow-lg group-hover:scale-110 transition">
                  {item.icon}
                </div>
                <div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900">
              Cost of Living in <span className="text-blue-600">Ireland</span>
            </h2>
            <p className="mt-4 text-gray-600 text-lg">
          ...
          <div className="overflow-hidden rounded-3xl shadow-2xl border border-white/40 backdrop-blur-xl">
            <div className="grid md:grid-cols-3 bg-gradient-to-r from-blue-600 via-emerald-600 to-blue-700 text-white font-semibold text-lg">
            ...
            {[
              {
                ...
                cost: "INR 20 lakh - INR 35 lakh per year",
                extra: [
              ...
              { title: "Groceries", cost: "INR 20000 monthly", extra: [] },
              {
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-6 text-lg text-gray-600">
              Ireland offers excellent career prospects with top global
              companies.
            </p>
          </div>
          ...
          <div className="mt-16">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 gap-8 items-center max-w-3xl mx-auto">
              {[
                { name: "Accenture", logo: "/image/google-logo.webp" },
                { name: "Deloitte", logo: "/image/microsoft.png" },
                { name: "KPMG", logo: "/image/amazon.png" },
              ].map((company, i) => (
                <div
                  key={i}
          ...
          <div className="mt-20 flex justify-center">
            <div className="relative p-[2px] rounded-3xl bg-gradient-to-r from-blue-500 via-emerald-500 to-blue-500 shadow-2xl max-w-xl w-full">
      ...
      >
        ...
        <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-emerald-300/30 blur-[120px] rounded-full animate-float delay-2000"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-6 text-lg text-gray-600">
              Ireland provides excellent work opportunities for international
              students.
            </p>
          </div>

          <div className="mt-20 grid md:grid-cols-2 gap-12">
            <div className="group relative rounded-3xl p-[2px] bg-gradient-to-r from-blue-500 via-emerald-500 to-blue-400 hover:scale-[1.02] transition duration-300">
              <div className="bg-white rounded-3xl p-10 shadow-xl h-full">
                <div className="w-16 h-16 mb-6 flex items-center justify-center bg-gradient-to-r from-blue-500 to-emerald-600 text-white rounded-2xl text-2xl shadow-lg">
                  💼
                </div>
                <h3 className="text-2xl font-semibold text-gray-900">
                  During Study
                ...
                <ul className="mt-6 text-gray-600 space-y-3">
                  <li>● Part-time work allowed (20 hours/week during term)</li>
                  <li>● Full-time work during holidays (40 hours/week)</li>
                </ul>
              </div>
            </div>

            <div className="group relative rounded-3xl p-[2px] bg-gradient-to-r from-emerald-500 via-blue-500 to-emerald-400 hover:scale-[1.02] transition duration-300">
              <div className="bg-white rounded-3xl p-10 shadow-xl h-full">
                <div className="w-16 h-16 mb-6 flex items-center justify-center bg-gradient-to-r from-emerald-500 to-blue-600 text-white rounded-2xl text-2xl shadow-lg">
                  🚀
                </div>
                <h3 className="text-2xl font-semibold text-gray-900">
                  After MBA
                </h3>
                <div className="mt-3 w-12 h-1 bg-emerald-600 rounded-full"></div>
                <ul className="mt-6 text-gray-600 space-y-3">
                  <li>
                    ● 2-year post-study work visa (Third Level Graduate Scheme)
                  </li>
                  <li>
          ...
          <div className="mt-20 relative">
            <div className="hidden md:block absolute top-8 left-0 right-0 h-[3px] bg-gradient-to-r from-blue-300 via-emerald-400 to-blue-300 opacity-40"></div>
            <div className="grid md:grid-cols-3 gap-10 text-center relative z-10">
              {[
                { icon: "🎓", title: "Study MBA in Ireland" },
                { icon: "💼", title: "Part-Time Work" },
                { icon: "🌟", title: "2-Year Stay Back" },
              ].map((step, i) => (
                <div key={i} className="group relative">
                  <div className="w-16 h-16 mx-auto flex items-center justify-center bg-gradient-to-r from-blue-500 to-emerald-600 text-white rounded-full text-2xl shadow-xl group-hover:scale-110 transition">
                    {step.icon}
                  </div>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-6 text-lg text-gray-600">
              Students who receive admission from an Irish university must apply
              for the Irish Student Visa.
            </p>
          </div>

          <div className="relative mt-20">
            <div className="hidden lg:block absolute top-8 left-0 right-0 h-[3px] bg-blue-200"></div>
            <div className="hidden lg:block absolute top-8 left-0 h-[3px] bg-gradient-to-r from-blue-500 to-emerald-600 animate-progress"></div>

            <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8 relative z-10">
              {[
                "Receive admission letter from Irish university",
                "Pay tuition fees & arrange funds (€7,000+ proof)",
                ...
                >
                  <div className="w-14 h-14 mx-auto flex items-center justify-center bg-gradient-to-r from-blue-500 to-emerald-600 text-white rounded-full text-lg font-bold shadow-lg group-hover:scale-110 transition">
          ...
          <div className="mt-20 relative bg-gradient-to-r from-blue-600 via-emerald-600 to-blue-700 text-white rounded-3xl p-12 text-center shadow-2xl overflow-hidden">
            ...
            <div className="relative z-10">
              <p className="text-lg max-w-3xl mx-auto">
                ...
                successful visa approval. Proof of funds of €7,000+ is required
                for living expenses.
              </p>
            </div>
          </div>
      ...
      <section className="relative pt-6 pb-20 bg-gradient-to-b from-white via-blue-50 to-white overflow-hidden">
        ...
        <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-emerald-300/40 blur-[150px] rounded-full animate-float delay-2000"></div>
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          <div className="mt-16 relative">
            <div className="absolute left-1/2 top-0 bottom-0 w-[3px] bg-gradient-to-b from-blue-400 via-emerald-500 to-blue-500 shadow-[0_0_15px_rgba(99,102,241,0.6)]"></div>
              ...
              >
                {i % 2 === 0 ? (
                  <div className="flex justify-end pr-8">
                    <div className="group w-full max-w-sm p-[2px] rounded-2xl bg-gradient-to-r from-blue-500 to-emerald-600">
                      <div className="backdrop-blur-xl bg-white/70 rounded-2xl p-5 shadow-xl flex items-center gap-3 transition duration-300 group-hover:scale-105">
                        <div className="w-10 h-10 flex items-center justify-center bg-gradient-to-r from-blue-500 to-emerald-600 text-white rounded-lg shadow-md">
                          {step.icon}
                        </div>
                ...
                {i % 2 !== 0 ? (
                  <div className="flex justify-start pl-8">
                    <div className="group w-full max-w-sm p-[2px] rounded-2xl bg-gradient-to-r from-emerald-500 to-blue-600">
                      <div className="backdrop-blur-xl bg-white/70 rounded-2xl p-5 shadow-xl flex items-center gap-3 transition duration-300 group-hover:scale-105">
                        <div className="w-10 h-10 flex items-center justify-center bg-gradient-to-r from-emerald-500 to-blue-600 text-white rounded-lg shadow-md">
                          {step.icon}
                        </div>
                        <p className="text-sm font-medium text-gray-800">
                          {step.title}
                ...
                <div className="absolute left-1/2 transform -translate-x-1/2 w-5 h-5 bg-gradient-to-r from-blue-500 to-emerald-600 rounded-full shadow-lg border-2 border-white"></div>
              </div>
            ))}
          </div>

          <div className="mt-20 relative bg-gradient-to-r from-blue-600 via-emerald-600 to-blue-700 text-white rounded-3xl p-10 text-center shadow-xl overflow-hidden">
            <div className="absolute -top-10 -left-10 w-72 h-72 bg-white/10 blur-3xl rounded-full animate-float"></div>
            <div className="absolute bottom-0 right-0 w-80 h-80 bg-white/10 blur-3xl rounded-full animate-float delay-2000"></div>
            <div className="relative z-10">
      ...
      <section className="relative pt-16 pb-24 bg-gradient-to-b from-white via-blue-50 to-white overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-gray-600 text-lg">
              Find answers to common questions about MBA in Ireland.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            {[
              {
                q: "Is MBA in Ireland worth it?",
                a: "Yes, especially for tech and consulting careers. Ireland offers excellent ROI, strong industry connections, and a 2-year post-study work visa.",
              },
              {
                q: "Is GMAT required for MBA in Ireland?",
                a: "Some universities require GMAT, while others may waive it based on work experience. Check specific university requirements.",
              },
            ].map((item, i) => (
              <div key={i} className="relative group cursor-pointer">
                <div onClick={() => setFaq(faq === i ? null : i)}>
                  <div
                    className={`absolute left-0 top-0 h-full w-1 rounded-full transition ${faq === i ? "bg-blue-600" : "bg-gradient-to-b from-blue-300 to-emerald-300"}`}
                  ></div>
                  <div className="pl-6">
      ...
      {/* CTA */}
      <section className="relative pt-6 pb-20 bg-gradient-to-r from-blue-700 to-emerald-800 text-white overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-6">
          <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl p-12 md:p-16 text-center shadow-2xl">
            ...
            <p className="mt-6 text-lg opacity-90">
              If you are planning to study MBA in Ireland, our expert
