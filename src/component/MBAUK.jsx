...
export default function MBAUK() {
  const [tab, setTab] = useState("academic");
  const steps = [
    {
      title: "	Full-Time MBA",
      detail: "1-year program, best for full focus on study.",
    },
    {
      title: "	Executive MBA",
      detail: "For working professionals to study with a job.",
    },
    {
      title: "	Part-Time MBA",
      detail: "Flexible classes on weekends or evenings.",
    },
    {
      title: " Online MBA",
      detail: "Study from anywhere with full flexibility.",
    },
    // {
    //   title: "Applying",
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              Study MBA in <span className="text-blue-600">UK</span> for Indian
              Students
            </h2>
            ...
            <div>
              <div className="bg-white rounded-3xl shadow-xl p-10 border border-gray-100">
                ...
                <p className="text-gray-600 leading-relaxed">
                  The United Kingdom is a popular choice for Indian students due
                  to its high-quality education and globally recognized
                  universities. Students get good exposure, practical learning,
                  and strong career opportunities.
                </p>

                <p className="mt-4 text-gray-600 leading-relaxed">
                  Most MBA programs in the UK are completed in just 1 year,
                  which helps save both time and cost while gaining
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              Why Study MBA in <span className="text-blue-600">UK</span>
            </h2>

            <p className="mt-6 text-lg text-gray-600">
              Studying in the United Kingdom offers unique advantages for
          ...
          <div className="mt-20 grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group relative p-8 rounded-3xl bg-white/90 backdrop-blur-md border shadow-md hover:shadow-2xl hover:-translate-y-3 transition duration-300 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-3 text-gray-600">
                  UK universities focus on quality education with practical and
            ...
            <div className="group relative p-8 rounded-3xl bg-white/90 backdrop-blur-md border shadow-md hover:shadow-2xl hover:-translate-y-3 transition duration-300 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-3 text-gray-600">
                  MBA programs in the UK are more focused, allowing students to
                  gain deep knowledge in a specific field.
                </p>
              </div>
            </div>
            ...
            <div className="group relative p-8 rounded-3xl bg-white/90 backdrop-blur-md border shadow-md hover:shadow-2xl hover:-translate-y-3 transition duration-300 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-3 text-gray-600">
                  Students get exposure to diverse cultures, helping improve
            ...
            <div className="group relative p-8 rounded-3xl bg-white/90 backdrop-blur-md border shadow-md hover:shadow-2xl hover:-translate-y-3 transition duration-300 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-3 text-gray-600">
                  Universities in the UK have strong links with industries,
                  helping students with placements and real-world experience.
                </p>
              </div>
            </div>
            ...
            <div className="group relative p-8 rounded-3xl bg-white/90 backdrop-blur-md border shadow-md hover:shadow-2xl hover:-translate-y-3 transition duration-300 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-3 text-gray-600">
                  Short duration + strong career opportunities = better value
                  for money
                </p>
              </div>
            </div>
            ...
            <div className="group relative p-8 rounded-3xl bg-white/90 backdrop-blur-md border shadow-md hover:shadow-2xl hover:-translate-y-3 transition duration-300 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-3 text-gray-600">
                  Studying in the UK also provides opportunities to explore and
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          ...
          <p className="text-center text-gray-600 mb-16">
            Choosing the right specialization in the United Kingdom is important
            for building a strong career.
          </p>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              Top Universities for MBA in UK and Their{" "}
              <span className="bg-blue-600  bg-clip-text text-transparent">
                Fees
              </span>
            </h2>
            <p className="mt-4 text-gray-600 text-lg">
              Explore top universities in the United Kingdom with UG, MS, and
              MBA fees.
            </p>
          </div>
      ...
      <section className="relative pt-6 pb-20 bg-gradient-to-b from-white via-blue-50 to-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-6 text-lg text-gray-600">
              Universities in the United Kingdom usually offer mainly one major
              intake for MBA programs, with some universities offering an
              additional intake.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="group relative bg-white rounded-3xl p-8 shadow-xl border border-blue-100 hover:shadow-2xl transition duration-300">
                ...
                <ul className="space-y-3 text-gray-700 text-sm">
                  <li>✔ Applications Open Period: Oct 2025 – Jan 2026</li>
                  <li>✔ Deadlines: Feb – Apr 2026</li>
                  <li>✔ Offer Letters: Mar – Jun 2026</li>
                  <li>✔ Classes Begin: Sep 2026</li>
                </ul>

                <div className="mt-5 text-xs text-gray-600 bg-blue-50 px-4 py-3 rounded-xl">
                  👉 Recommended preparation start: <b>Mid 2025</b>
                </div>
              </div>
              ...
              <div className="group relative bg-white rounded-3xl p-8 shadow-xl border border-indigo-100 hover:shadow-2xl transition duration-300">
                ...
                <h4 className="text-xl font-semibold text-indigo-700 mb-6 flex items-center gap-2">
                  🌱 January 2027 Intake (Limited Universities)
                </h4>

                <ul className="space-y-3 text-gray-700 text-sm">
                  <li>✔ Applications Open Period: Jun – Sep 2026</li>
                  <li>✔ Deadlines: Oct – Nov 2026</li>
                  <li>✔ Offer Letters: Nov – Dec 2026</li>
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-4">
              ...
              <div className="text-center mb-16">
                <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                  Types of MBA Programs in UK
                </h2>

                <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                  A complete roadmap designed to guide you through every step of
                  your MBA journey in the United Kingdom, from choosing the
                  right university to securing your visa.
                </p>
              </div>
    ...
    scale-150 z-[-1] animate-pulse"
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-3xl p-12 shadow-2xl text-center text-white relative overflow-hidden">
            ...
            <p className="mt-6 text-lg opacity-90 max-w-3xl mx-auto">
              To apply for MBA in the UK, Indian students must meet the
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              Cost of Studying MBA in <span className="text-blue-600">UK</span>
            </h2>
            ...
            <div className="group relative p-10 rounded-3xl bg-white/70 backdrop-blur-xl border border-indigo-200 shadow-xl hover:shadow-2xl transition duration-500 overflow-hidden">
              ...
              <div className="relative bg-white/90 rounded-3xl p-8 z-10">
                ...
                <p className="mt-6 text-gray-600 leading-relaxed">
                  Students typically spend around $12,000 – $18,000 per year on
      ...
      <section className="pt-10 pb-20 bg-gradient-to-b from-white via-blue-50 to-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="overflow-hidden rounded-3xl shadow-2xl border border-white/40 backdrop-blur-xl">
            ...
            {[
              {
                title: "Annual Tuition Fee (MBA)",
                cost: "INR 30 lakh – 1.2 Cr (total program)",
                extra: [
                  "Top universities zyada expensive hote hain",
                  "Course duration (mostly 1 year)",
                ],
              },
              {
                title: "Accommodation",
                cost: "INR 80,000 – 1,80,000 monthly",
                extra: ["London vs other cities", "Shared or private housing"],
              },
              {
                title: "Food & Dining",
                cost: "INR 20,000 – 40,000 monthly",
                extra: ["Eating habits"],
              },
              {
                title: "Phone & Internet",
                cost: "INR 1,500 – 3,000 monthly",
                extra: ["Data usage & plan"],
              },
              {
                title: "Groceries & Essentials",
                cost: "INR 12,000 – 25,000 monthly",
                extra: ["Lifestyle choices"],
              },
              {
                title: "Public Transportation",
                cost: "INR 10,000 – 18,000 monthly",
                extra: ["Travel frequency & city"],
              },
              {
                title: "Healthcare (IHS Fee)",
                cost: "INR 60,000 – 90,000 yearly",
                extra: [
                  "Visa duration",
                  // "Student’s age",
                ],
              },
              {
                ...
                cost: "INR 12,000 – 22,000 monthly",
                extra: ["Heating, electricity, internet"],
              },
            ].map((row, i) => (
              <div
                key={i}
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-6 text-lg text-gray-600">
              Many universities and organizations in the United Kingdom offer
              scholarships to help MBA students reduce their financial burden.
            </p>
          </div>
            ...
            {[
              {
                ...
                details: "	Prepare IELTS & GMAT.",
              },
              {
                // icon: "💰",
                title: "8–10 Months Before:",
                details: "Shortlist universities.",
              },
              {
                // icon: "👨‍🏫",
    ...
    bg-gradient-to-br from-blue-100/40 via-indigo-100/20 to-purple-100/30"
          ...
          <div className="mt-20 relative bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 text-white rounded-3xl p-12 text-center shadow-2xl overflow-hidden">
            ...
            <div className="relative z-10">
              <p className="text-lg max-w-3xl mx-auto">
                Scholarships for MBA in the United Kingdom are awarded based on
                academic performance, leadership skills, or financial need.
              </p>
            </div>
          </div>
        </div>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-6 text-lg text-gray-600">
              The UK offers excellent job prospects after completing MBA.
            </p>
          </div>
          ...
          <div className="mt-16">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 gap-4 items-center justify-items-center max-w-sm mx-auto">
              {[
                // { name: "Google", logo: "/image/google-logo.webp" },
                // { name: "Microsoft", logo: "/image/microsoft.png" },
                // { name: "Amazon", logo: "/image/amazon.png" },

                { name: "McKinsey", logo: "	McKinsey & Company" },
                { name: "Boston", logo: "		Boston Consulting Group" },
                { name: "Bain", logo: "		Bain & Company" },
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-6 text-lg text-gray-600">
              The UK offers excellent work opportunities during and after
              completing MBA.
            </p>
          </div>
      ...
      bg-gradient-to-br from-indigo-100/40 via-blue-100/20 to-purple-100/30"
        ...
        group-hover:scale-110 transition"
                  ...
                  {/* content */}
                  <ul className="mt-6 text-gray-600 space-y-3">
                    <li>● Graduate Route Visa (2 years)</li>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-6 text-lg text-gray-600">
              Students who receive admission from a UK university must apply for
      ...
      <section className="relative pt-6 pb-20 bg-gradient-to-b from-white via-blue-50 to-white overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              Why Choose{" "}
              <span className="text-blue-600">Us for MBA in UK?</span>
            </h2>

            <p className="mt-6 text-lg text-gray-600">
              Planning to pursue an MBA in the United Kingdom? Get complete
              support for university selection, applications, scholarships, and
              visa process to make your study abroad journey smooth and
              successful.
            </p>
          </div>
          ...
          <div className="mt-20 relative bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 text-white rounded-3xl p-10 text-center shadow-xl overflow-hidden">
            ...
            <div className="relative z-10">
              <p className="text-lg max-w-2xl mx-auto">
                Our experienced counsellors guide you at every step of your MBA
                admission process in the United Kingdom, from choosing the right
                university to application and visa assistance.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-12 gap-16 items-start">
            ...
            <div className="lg:col-span-7 space-y-6">
              {[
                {
                  q: "Is MBA in UK worth it?",
                  a: "Yes, due to short duration and global exposure.",
                },
                {
                  q: "Is work experience required?",
                  a: "Yes, for top universities",
                },
                // {
        ...
        <div className="relative max-w-5xl mx-auto px-6">
          ...
          <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl p-12 md:p-16 text-center shadow-2xl">
            ...
            <div className="mt-10 flex justify-center gap-6 flex-wrap">
              ...
              >
                Get expert counseling and complete admission support.
              </Link>
