  ...
  `}</style>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              Study MS in <span className="text-blue-600">Canada</span> for
              Indian Students
            </h2>
            ...
            <div>
              <div className="bg-white rounded-3xl shadow-xl p-10 border border-gray-100">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Canada is one of the most preferred destinations for Indian
                  students pursuing a Master of Science (MS) due to its
                  high-quality education system, affordable tuition fees, and
                  excellent post-study work opportunities.
                </p>

                <p className="mt-4 text-gray-600 leading-relaxed">
                  With a rapidly growing international student population,
                  Canada offers a safe, welcoming environment along with
                  globally recognized degrees and strong career prospects.
                </p>
              </div>
              ...
              <div className="mt-8 grid grid-cols-2 gap-4">
                {[
                  ...
                  "Excellent post-study work opportunities (PGWP)",
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              Why Study MS in <span className="text-blue-600">Canada</span>
            </h2>

            <p className="mt-6 text-lg text-gray-600">
              Canada is a preferred destination for MS due to its high-quality
              education, research opportunities, and immigration-friendly
              policies.
            </p>
          </div>
          ...
          <div className="mt-20 grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group relative p-8 rounded-3xl bg-white/90 backdrop-blur-md border shadow-md hover:shadow-2xl hover:-translate-y-3 transition duration-300 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-3 text-gray-600">
                  Canada offers internationally recognized degrees from reputed
                  universities that are respected by employers worldwide and
            ...
            <div className="group relative p-8 rounded-3xl bg-white/90 backdrop-blur-md border shadow-md hover:shadow-2xl hover:-translate-y-3 transition duration-300 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-3 text-gray-600">
                  Canadian universities emphasize research-based learning,
                  allowing students to work on real-world projects, collaborate
                  with experts, and gain hands-on experience in their field of
                  study.
                </p>
              </div>
            </div>
            ...
            <div className="group relative p-8 rounded-3xl bg-white/90 backdrop-blur-md border shadow-md hover:shadow-2xl hover:-translate-y-3 transition duration-300 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-3 text-gray-600">
                  Canada offers a strong and growing job market with high demand
                  for skilled professionals, providing excellent employment
                  opportunities for graduates across various industries.
                </p>
              </div>
            </div>
            ...
            <div className="group relative p-8 rounded-3xl bg-white/90 backdrop-blur-md border shadow-md hover:shadow-2xl hover:-translate-y-3 transition duration-300 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-3 text-gray-600">
                  Canada offers a clear pathway to Permanent Residency (PR),
                  allowing international students to stay and build their future
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          <h2 className="text-4xl font-bold text-center mb-6">
            Popular MS Specializations in Canada
          </h2>
      ...
      <section className="relative pt-6 pb-20 bg-gradient-to-b from-white via-blue-50 to-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              Intakes for MS in <span className="text-blue-600">Canada</span>
            </h2>

            <p className="mt-6 text-lg text-gray-600">
              Canadian universities typically offer two major intakes for MS
              programs.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-3xl p-12 shadow-2xl text-center text-white relative overflow-hidden">
            ...
            <p className="mt-6 text-lg opacity-90 max-w-3xl mx-auto">
              To apply for MS in Canada, students must meet the following
              requirements:
            </p>
            ...
            <div className="mt-12 bg-white rounded-3xl p-10 shadow-xl text-gray-700">
              ...
              {tab === "language" && (
                <div>
                  ...
                  <ul className="mt-4 space-y-3">
                    <li>● GRE (required in some universities)</li>
                  </ul>
                </div>
              )}
            ...
            <div className="group relative p-10 rounded-3xl bg-white/70 backdrop-blur-xl border border-indigo-200 shadow-xl hover:shadow-2xl transition duration-500 overflow-hidden">
              ...
              <div className="relative bg-white/90 rounded-3xl p-8 z-10">
                ...
                <p className="mt-6 text-gray-600 leading-relaxed">
                  Students typically spend around CAD 10,000 – CAD 15,000 per
            ...
            {[
              {
                ...
                extra: [
                  ...
                  "Depends upon the study in Canada course selected",
                ],
              },
              {
                title: "Accommodation",
            ...
            {[
              {
                ...
                details:
                  "Offered by the Canadian government to support international students with tuition fees, living expenses, and other costs.",
              },
              {
                icon: "🎓",
                title: "University Scholarships",
                details:
                  "Provided by universities based on academic merit, achievements, and overall student performance.",
              },
              {
                icon: "🔬",
                title: "Research Assistantships",
                details:
                  "Students work on research projects under faculty guidance and receive financial support or stipends.",
              },
            ].map((item, i) => (
              <div
                key={i}
...
group-hover:scale-110 transition"
          ...
          <div className="mt-20 relative bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 text-white rounded-3xl p-12 text-center shadow-2xl overflow-hidden">
            ...
            <div className="relative z-10">
              <p className="text-lg max-w-3xl mx-auto">
                ...
                Canada and help students focus on their academic journey.
              </p>
            </div>
          </div>
        </div>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-6 text-lg text-gray-600">
              Canada offers strong career opportunities for international
              graduates.
            </p>
          </div>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-6 text-lg text-gray-600">
              International students in Canada can work during their studies and
      ...
      bg-gradient-to-br from-indigo-100/40 via-blue-100/20 to-purple-100/30"
        ...
        group-hover:scale-110 transition"
                  ...
                  {/* content */}
                  <p className="mt-6 text-gray-600 leading-relaxed">
                    After graduation, students may be eligible for a{" "}
                    <span className="font-semibold">PGWP of up to 3 years</span>
                    , allowing them to gain valuable work experience in Canada.
                  </p>
                </div>
              </div>
            </div>
  ...
  `}</style>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-6 text-lg text-gray-600">
              Students require a Canada Study Permit to pursue undergraduate
              studies.
            </p>
          </div>
      ...
      group-hover:scale-110 transition"
          ...
          <div className="mt-20 relative bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 text-white rounded-3xl p-12 text-center shadow-2xl overflow-hidden">
            ...
            <div className="relative z-10">
              <p className="text-lg max-w-3xl mx-auto">
                Proper documentation and timely application increase the chances
                of visa approval.
              </p>
            </div>
          </div>
