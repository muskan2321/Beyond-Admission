...
import { FaBook, FaBookReader, FaHandsHelping, FaLaptopCode } from "react-icons/fa";
...
<div className="w-full bg-gradient-to-r from-[#4979ca] to-[#e672de]">
  ...
  <Slider {...settings3}>
    ...
    <div className="w-full mt-10">
                    <div className="grid grid-cols-1 sm:grid-cols-2 px-4 sm:px-6 lg:px-16 gap-6 ">
                        <div id="mbbs" className="rounded-2xl bg-card p-8 shadow-lg scroll-mt-24">
    
      <div className="inline-flex h-14 w-14 items-center justify-center rounded-xl bg-red-500 text-white">
      ...
      <p className="mt-3 text-muted-foreground">
        Study medicine at top medical colleges in India and abroad. Affordable MBBS
        programs in Russia, Philippines, China, and more.
      </p>
      ...
      <div className="mt-6">
        ...
        <ul className="mt-3 space-y-2">
          <li className="flex items-center gap-2">
            ...
            <span className="text-sm text-muted-foreground">MBBS in Russia</span>
          </li>
          <li className="flex items-center gap-2">
            <IoCheckmarkCircle className="text-green-500 text-lg" />
            <span className="text-sm text-muted-foreground">MBBS in Philippines</span>
          </li>
          <li className="flex items-center gap-2">
            <IoCheckmarkCircle className="text-green-500 text-lg" />
            <span className="text-sm text-muted-foreground">MBBS in China</span>
          </li>
          <li className="flex items-center gap-2">
            <IoCheckmarkCircle className="text-green-500 text-lg" />
            <span className="text-sm text-muted-foreground">MBBS in Ukraine</span>
          </li>
          <li className="flex items-center gap-2">
            <IoCheckmarkCircle className="text-green-500 text-lg" />
            <span className="text-sm text-muted-foreground">MBBS in India</span>
          </li>
        </ul>
      </div>
      ...
      <a
        href="/contact"
        className="mt-6 inline-flex h-10 items-center justify-center gap-2 rounded-md border px-4 text-sm font-medium hover:bg-accent"
      >
        Inquire Now →
      </a>
    </div>
    
                <div id="paramedical" className="rounded-2xl bg-card p-8 shadow-lg scroll-mt-24">
    
      <div className="inline-flex h-14 w-14 items-center justify-center rounded-xl bg-blue-500 text-white">
      ...
      <p className="mt-3 text-muted-foreground">
        MBBS, B.Pharma, and MS programs in top medical colleges.
      </p>
    
      <a
        href="/contact"
        className="mt-6 inline-flex h-10 items-center justify-center rounded-md border px-4"
      >
        Inquire Now →
      </a>
    </div>
