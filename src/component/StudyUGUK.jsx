...
export default function StudyCanada() {
  ...
  const steps = [
    ...
    },
    {
      title: "Applying",
      detail:
        "Submit applications on UCAS portal and track deadlines carefully.",
    },
    {
      title: "Offer Letter",
        ...
        <div className="relative max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center z-10">
          ...
          <div>
            ...
            <p className="mt-6 text-lg md:text-xl text-white/80 max-w-xl">
              Globally recognized degrees & 3-year specialized programs
            </p>
  ...
  `}</style>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              Study UG in <span className="text-blue-600">UK</span> for Indian
              Students
            </h2>

            <p className="mt-4 text-gray-600 text-lg">
              Discover world-class education, 3-year specialized programs, and
            ...
            <div>
              <div className="bg-white rounded-3xl shadow-xl p-10 border border-gray-100">
                ...
                <p className="text-gray-600 leading-relaxed">
                  The United Kingdom is a top destination for Indian students
                  after 12th due to its shorter course duration, focused
                  curriculum, and globally recognized degrees. Unlike the USA,
                  UK universities offer specialized education from the first
                  year, helping students enter the workforce faster.
                </p>

                <p className="mt-4 text-gray-600 leading-relaxed">
                  With a rich academic heritage and a student-friendly
                  environment, the UK offers a perfect blend of tradition and
                  innovation.
                </p>
              </div>
              ...
              <div className="mt-8 grid grid-cols-2 gap-4">
                {[
                  ...
                  "Pathway to Graduate Route Visa",
                ].map((item, index) => (
                  <div
                    key={index}
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              Why Study UG in <span className="text-blue-600">UK</span>
            </h2>

            <p className="mt-6 text-lg text-gray-600">
              The UK is a top destination for Indian students after 12th due to
              its shorter course duration, focused curriculum, and globally
              recognized degrees.
            </p>
          </div>
          ...
          <div className="mt-20 grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group relative p-8 rounded-3xl bg-white/90 backdrop-blur-md border shadow-md hover:shadow-2xl hover:-translate-y-3 transition duration-300 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-3 text-gray-600">
                  UK universities offer degrees that are respected worldwide and
                  help students build strong international careers.
                </p>
              </div>
            </div>
            ...
            <div className="group relative p-8 rounded-3xl bg-white/90 backdrop-blur-md border shadow-md hover:shadow-2xl hover:-translate-y-3 transition duration-300 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-3 text-gray-600">
                  Most UG programs in the UK are completed in just 3 years,
                  saving both time and tuition costs.
                </p>
              </div>
            </div>
            ...
            <div className="group relative p-8 rounded-3xl bg-white/90 backdrop-blur-md border shadow-md hover:shadow-2xl hover:-translate-y-3 transition duration-300 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-3 text-gray-600">
                  Students focus on their chosen subject from the beginning,
                  gaining deeper expertise early.
                </p>
              </div>
            </div>
            ...
            <div className="group relative p-8 rounded-3xl bg-white/90 backdrop-blur-md border shadow-md hover:shadow-2xl hover:-translate-y-3 transition duration-300 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-3 text-gray-600">
                  UK universities emphasize practical skills and industry
                  exposure, boosting job opportunities.
                </p>
              </div>
            </div>
            ...
            <div className="group relative p-8 rounded-3xl bg-white/90 backdrop-blur-md border shadow-md hover:shadow-2xl hover:-translate-y-3 transition duration-300 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-3 text-gray-600">
                  Study alongside students from across the world and build a
            ...
            <div className="group relative p-8 rounded-3xl bg-white/90 backdrop-blur-md border shadow-md hover:shadow-2xl hover:-translate-y-3 transition duration-300 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-3 text-gray-600">
                  The UK offers post-study work visas, allowing students to gain
                  international work experience after graduation.
                </p>
              </div>
            </div>
          </div>
            ...
            {[
              {
                ...
                icon: "💻",
                salary: "£30,000+ Avg Starting Salary",
                duration: "3 Years",
                courses: [
                  "Computer Science",
              ...
              },
              {
                ...
                icon: "📊",
                salary: "£28,000+ Avg Starting Salary",
                duration: "3 Years",
                courses: [
                  "Business Management",
                  "Marketing",
              ...
              },
              {
                ...
                icon: "💰",
                salary: "£32,000+ Avg Starting Salary",
                duration: "3 Years",
                courses: [
                  "Economics",
                  "Finance",
              ...
              },
              {
                ...
                img: "/image/Engineering & Technology.webp",
                icon: "🧬",
                salary: "£26,000+ Avg Starting Salary",
                duration: "3 Years",
                courses: [
                  "Biology",
                  "Biochemistry",
              ...
              },
              {
                ...
                img: "/image/Undergraduate Programs.webp",
                icon: "🎨",
                salary: "£24,000+ Avg Starting Salary",
                duration: "3 Years",
                courses: [
                  "Fine Arts",
                  "Graphic Design",
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              Top Universities in UK and Their{" "}
              ...
              {[
                {
                  ...
                  ug: "£33,000 – £48,000 / year",
                  ranking: "#3",
                },
                {
                  name: "University of Cambridge",
                  ug: "£25,000 – £45,000 / year",
                  ranking: "#2",
                },
                {
                  name: "University College London (UCL)",
                  ug: "£25,000 – £40,000 / year",
                  ranking: "#9",
                },
                {
                  name: "University of Manchester",
                  ug: "£22,000 – £36,000 / year",
                  ranking: "#32",
                },
                {
                  name: "University of Edinburgh",
                  ug: "£23,000 – £37,000 / year",
                  ranking: "#22",
                },
                {
                  name: "King's College London",
                  ug: "£24,000 – £38,000 / year",
                  ranking: "#40",
                },
                {
                  name: "University of Warwick",
                  ug: "£24,000 – £35,000 / year",
                  ranking: "#67",
                },
              ].map((row, i) => (
                <div
      ...
      {/* TYPES OF UG DEGREES */}
      <section className="relative pt-10 pb-20 bg-gradient-to-b from-white via-blue-50 to-white overflow-hidden">
        {/* Background Glow */}
        <div className="absolute -top-20 -left-20 w-80 h-80 bg-blue-300/20 rounded-full blur-3xl"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              Types of UG Degrees in <span className="text-blue-600">UK</span>
            </h2>
            <p className="mt-4 text-gray-600 text-lg">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="group relative rounded-2xl bg-white p-8 shadow-lg hover:shadow-2xl transition duration-300 hover:-translate-y-2 overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="text-sm text-amber-600 font-semibold mb-3">BBA</p>
                <p className="text-gray-600 text-sm">
          ...
          <div className="mt-12 text-center">
            <p className="text-gray-500 text-sm">
              * Most undergraduate programs in the UK are 3 years in duration,
              with some integrated master's programs available
            </p>
          </div>
        </div>
      </section>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              Intakes for UG in <span className="text-blue-600">UK</span>
            </h2>

            <p className="mt-6 text-lg text-gray-600">
              UK universities typically offer two major intakes for
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="group relative bg-white rounded-3xl p-8 shadow-xl border border-blue-100 hover:shadow-2xl transition duration-300">
                ...
                <ul className="space-y-3 text-gray-700 text-sm">
                  <li>✔ Applications Open: Sep – Jan</li>
                  <li>✔ UCAS Deadline: Jan 15 (most courses)</li>
                  <li>✔ Offer Letters: Jan – Mar</li>
              ...
              <div className="group relative bg-white rounded-3xl p-8 shadow-xl border border-indigo-100 hover:shadow-2xl transition duration-300">
                ...
                <ul className="space-y-3 text-gray-700 text-sm">
                  <li>✔ Applications Open: May – Sep</li>
                  <li>✔ Deadlines: Oct – Nov</li>
                  <li>✔ Offer Letters: Nov – Dec</li>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              ...
              <span className="text-blue-600">UG in UK</span>
            </h2>
            <p className="mt-4 text-gray-600 text-lg">
          ...
          <div className="mt-16 grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 shadow-md">
              ...
              <ul className="space-y-3 text-sm text-gray-700">
                ...
                <li className="flex justify-between items-center pb-2 border-b border-blue-200">
                  <span>Most undergraduate courses</span>
                  <span className="font-semibold text-blue-600">
                    January 15
                  </span>
                </li>
                <li className="flex justify-between items-center">
                  <span>UCAS Extra</span>
                  <span className="font-semibold text-blue-600">
                    February - July
                  </span>
                </li>
            ...
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-6 shadow-md">
              ...
              <p className="text-sm text-gray-600 mb-3">
                If you miss the main deadlines, UCAS Clearing runs from{" "}
                <span className="font-semibold">July to October</span>. You can
                apply for courses that still have available places.
              </p>
              <div className="mt-3 p-3 bg-white/60 rounded-lg">
                <p className="text-xs text-gray-500">
                  <span className="font-semibold">Tip:</span> Start your
                  application early to avoid last-minute stress and ensure all
                  documents are ready.
                </p>
              </div>
            </div>
    ...
    scale-150 z-[-1] animate-pulse"
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-3xl p-12 shadow-2xl text-center text-white relative overflow-hidden">
            ...
            <h2 className="text-4xl md:text-5xl font-bold">
              Eligibility Criteria for UG in UK
            </h2>

            <p className="mt-6 text-lg opacity-90 max-w-3xl mx-auto">
              To apply for undergraduate programs in the UK, students must meet
                ...
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  ...
                  <div>
                    ...
                    <ul className="mt-4 space-y-3">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="text-blue-600 text-lg">●</span>
                        <span>Minimum 70%–90% (varies by university)</span>
                      </li>
                    </ul>
                    ...
                    <ul className="space-y-4">
                      <li className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            In most cases, UK universities do not require SAT
                            scores for undergraduate admissions
                          </p>
                        </div>
                      </li>
                      {/* <li className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="font-semibold text-gray-800">Some courses may require additional tests</p>
                          <p className="text-sm text-gray-600">Medicine (UCAT/BMAT), Law (LNAT), and Mathematics (STEP/MAT) may require specific entrance exams</p>
                        </div>
                      </li> */}
                    </ul>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-2xl p-6">
                      ...
                      <ul className="space-y-2 text-sm text-gray-700">
                        <li>● TOEFL iBT: 80 – 100</li>
                        <li>● PTE Academic: 56 – 68</li>
                ...
                <div>
                  ...
                  <div className="mt-6 p-4 bg-blue-100 rounded-xl">
                    <p className="text-sm text-gray-700 text-center">
                      ...
                      Submit your UCAS application by the deadline (usually
                      January 15 for most courses). Oxford, Cambridge, and
                      Medicine/Dentistry/Veterinary deadlines are earlier
                      (October 15).
                    </p>
                  </div>
                </div>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              Cost of Studying UG in <span className="text-blue-600">UK</span>
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900">
              Cost of Living in <span className="text-blue-600">UK</span>
            </h2>
            <p className="mt-4 text-gray-600 text-lg">
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="mt-20 grid md:grid-cols-2 gap-10">
            ...
            <div className="group relative rounded-3xl p-[2px] bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 transition duration-300 hover:scale-[1.02]">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <div className="mt-4">
                    <p className="text-gray-600 text-sm leading-relaxed">
                      ...
                      achievements, outstanding grades, and excellent
            ...
            <div className="group relative rounded-3xl p-[2px] bg-gradient-to-r from-green-500 via-emerald-500 to-teal-500 transition duration-300 hover:scale-[1.02]">
              <div className="bg-white rounded-3xl p-10 h-full shadow-xl overflow-hidden relative">
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition duration-500 bg-gradient-to-br from-green-100/40 via-emerald-100/20 to-teal-100/30"></div>
                ...
                <div className="relative z-10 text-center">
                  ...
                  <div className="mt-4">
                    <p className="text-gray-600 text-sm leading-relaxed">
                      Financial assistance provided to students who demonstrate
                      genuine financial need and require support for tuition and
                      living expenses.
                    </p>
                  </div>
                </div>
            ...
            <div className="group relative rounded-3xl p-[2px] bg-gradient-to-r from-purple-500 via-pink-500 to-rose-500 transition duration-300 hover:scale-[1.02]">
              <div className="bg-white rounded-3xl p-10 h-full shadow-xl overflow-hidden relative">
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition duration-500 bg-gradient-to-br from-purple-100/40 via-pink-100/20 to-rose-100/30"></div>
            ...
            <div className="group relative rounded-3xl p-[2px] bg-gradient-to-r from-amber-500 via-orange-500 to-red-500 transition duration-300 hover:scale-[1.02]">
              <div className="bg-white rounded-3xl p-10 h-full shadow-xl overflow-hidden relative">
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition duration-500 bg-gradient-to-br from-amber-100/40 via-orange-100/20 to-red-100/30"></div>
                ...
                <div className="relative z-10 text-center">
                  ...
                  <div className="mt-4">
                    <p className="text-gray-600 text-sm leading-relaxed">
                      Prestigious scholarships funded by the UK government and
                      partner organizations to support outstanding international
                      students.
                    </p>
                  </div>
                </div>
          ...
          <div className="mt-20 relative bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 text-white rounded-3xl p-12 text-center shadow-2xl overflow-hidden">
            ...
            <div className="relative z-10">
              <p className="text-lg max-w-3xl mx-auto">
                ...
                the UK and help students focus on their academic journey.
              </p>
            </div>
          </div>
        </div>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-6 text-lg text-gray-600">
              The UK offers strong career opportunities for international
              graduates.
            </p>
          </div>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-6 text-lg text-gray-600">
              International students in the UK can work during their studies and
              also explore post-study work opportunities after graduation.
            </p>
          </div>
      ...
      bg-gradient-to-br from-indigo-100/40 via-blue-100/20 to-purple-100/30"
        ...
        group-hover:scale-110 transition"
                  ...
                  {/* content */}
                  <p className="mt-6 text-gray-600 leading-relaxed">
                    After graduation, students may be eligible for the{" "}
                    <span className="font-semibold">Graduate Route Visa</span>,
                    allowing them to work in the UK for up to 2 years.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mt-20 relative">
            ...
            <div className="grid md:grid-cols-4 gap-10 text-center relative z-10">
              {[
                ...
                {
                  icon: "🚀",
                  title: "Graduate Route up to 2 Years",
                },
                {
                  icon: "🌟",
                  title: "Career Growth",
  ...
  `}</style>
      ...
      <section className="relative pt-6 pb-20 bg-gradient-to-b from-white via-blue-50 to-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              Why Choose Us for <span className="text-blue-600">UG in UK?</span>
            </h2>
            <p className="mt-4 text-gray-600 text-lg">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group relative rounded-2xl bg-white p-8 shadow-lg hover:shadow-2xl transition duration-300 hover:-translate-y-2 overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="mt-3 text-gray-600 text-sm leading-relaxed">
                  End-to-end assistance with UCAS applications, document
                  preparation, and deadline tracking.
                </p>
              </div>
            </div>
            ...
            <div className="group relative rounded-2xl bg-white p-8 shadow-lg hover:shadow-2xl transition duration-300 hover:-translate-y-2 overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="mt-3 text-gray-600 text-sm leading-relaxed">
                  Complete support for UK student visa application,
  ...
  `}</style>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              Visa Process for <span className="text-blue-600">UG in UK</span>
            </h2>

            <p className="mt-6 text-lg text-gray-600">
              Students need a UK Student Visa to pursue undergraduate studies in
              the UK.
            </p>
          </div>
          ...
          <div className="relative mt-20">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 relative z-10">
              {[
                ...
                "Pay visa fee & IHS (Immigration Health Surcharge)",
      ...
      <section className="relative py-24 bg-gradient-to-b from-white via-blue-50 to-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="mt-4 text-gray-600 text-lg">
              Everything you need to know about studying UG in UK
            </p>
          </div>
              ...
              {[
                {
                  ...
                  a: "Yes, Indian students can directly apply for undergraduate programs after completing 12th with required academic scores.",
                },
                {
                  q: "Is IELTS mandatory?",
                  a: "Yes, most universities require IELTS or equivalent English test. Some may waive it based on your schooling.",
                },
                {
                ...
                {
                  q: "Is UK good for UG?",
                  a: "Yes, due to shorter duration, specialized learning, and excellent global career opportunities.",
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className={`group rounded-2xl border transition duration-300 ${
                    activeFaq === i
            ...
            <div className="relative group">
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-1xl">
                ...
                <div className="absolute bottom-6 left-6 right-6 bg-white/90 backdrop-blur-md rounded-xl p-4">
                  <p className="font-semibold text-gray-800">🎓 Study in UK</p>
