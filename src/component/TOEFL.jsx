...
export default function TOEFL() {
  ...
  const [openIndex, setOpenIndex] = useState(null);
   ...
   const reviews = [
     {
       text: "Best IELTS coaching with excellent faculty support. The trainers explain each module in detail and provide regular feedback, which helped me improve my band score effectively.",
       name: "Sahil Khanna",
     },
     {
       text: "Great study material and amazing doubt support. The practice tests and one-on-one guidance made my preparation much more structured and result-oriented.",
       name: "Riya Sharma",
     },
     {
       text: "Helped me improve my score significantly. The speaking practice sessions and writing evaluations were extremely useful in boosting my confidence.",
       name: "Aman Verma",
     },
     {
       text: "Highly recommended for serious aspirants. The overall experience, from expert faculty to well-designed course structure, is excellent and very helpful.",
       name: "Neha Gupta",
     },
   ];
  ...
  return (
    <div className="bg-white font-[Inter]">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              What is the <span className="text-blue-600">TOEFL Exam?</span>
            </h2>
            ...
            <div className="relative group">
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur-md rounded-2xl p-5 shadow-lg flex justify-between items-center">
                <div>
                  ...
                  <p className="text-3xl font-bold text-blue-600">0–120</p>
                </div>
            ...
            <div>
              <div className="bg-white rounded-3xl shadow-xl p-10 border border-gray-100">
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  Educational Testing Service. It is accepted by 11,500+
                  universities across 160+ countries and is widely used for
                  study abroad, work opportunities, and immigration purposes.
                </p>
                <p className="mt-4 text-gray-600 leading-relaxed">
                  TOEFL is a globally accepted English proficiency test
                  conducted in 180+ countries, with internet-based testing for
                  easy access. It is recognized by 5,000+ institutions across 80
                  countries.
                </p>
                <p className="mt-4 text-gray-600 leading-relaxed">
                  The TOEFL evaluates your ability in:
                </p>
              </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600">
              TOEFL exam pattern consists of four main sections: Reading,
            ...
            <table className="w-full border border-gray-300 text-left">
              <thead className="bg-gray-100">
                <tr className="bg-yellow-500">
                  <th className="border p-4 font-semibold">Section</th>
                  <th className="border p-4 font-semibold">Duration</th>
              ...
              <tbody className="text-black-700">
                <tr>
                  ...
                  <td className="border p-4">36 minutes</td>
                  <td className="border p-4">28</td>
                </tr>
                <tr className="bg-gray-50">
                  <td className="border p-4 font-bold">Writing</td>
                  <td className="border p-4">29 minutes</td>
                  <td className="border p-4">2</td>
                </tr>
                <tr>
                  <td className="border p-4 font-bold">Speaking</td>
                  <td className="border p-4">16 minutes</td>
                  <td className="border p-4">4</td>
                </tr>
                <tr className="bg-gray-50">
                  <td className="border p-4 font-bold">Reading</td>
                  <td className="border p-4">35 minutes</td>
                  <td className="border p-4">20</td>
                </tr>
                <tr className="bg-gray-100 font-semibold">
                  <td className="border p-4">Total Duration</td>
                  <td className="border p-4">116 minutes</td>
          ...
          {/* Detailed Pattern Section */}
          <div className="mt-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">
              TOEFL Exam Syllabus 2026
            </h2>
            <p className="text-gray-600 text-center mb-10">
              TOEFL is a globally approved English language proficiency test
              with a recently updated syllabus designed to suit modern academic
              requirements.
            </p>

            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-yellow-200 rounded-2xl p-6 shadow-md border border-gray-100">
                <h3 className="text-xl font-bold text-black-800 mb-3">
                  Reading
                </h3>
                <p className="text-black-600 text-sm mb-3">
                  <span className="font-semibold">Purpose:</span> Evaluates
                  ability to read, understand and analyze academic texts.
                </p>
                <p className="text-black-600 text-sm mb-3">
                  <span className="font-semibold">Time Duration:</span> 54-72
                  minutes
                </p>
                <ul className="text-black-600 text-sm list-disc list-inside space-y-1">
                  <li>3-4 academic passages</li>
                  <li>Each passage includes around 10 questions</li>
                  <li>Focus on comprehension, inference and vocabulary</li>
                </ul>
              </div>
              ...
              <div className="bg-yellow-200 rounded-2xl p-6 shadow-md border border-gray-100">
                ...
                <p className="text-black-600 text-sm mb-3">
                  <span className="font-semibold">Purpose:</span> Assesses how
                  well candidates understand spoken English in academic and
                  real-life situations.
                </p>
                <p className="text-black-600 text-sm mb-3">
                  <span className="font-semibold">Time Duration:</span> Included
                  in total test time
                </p>
                <ul className="text-black-600 text-sm list-disc list-inside space-y-1">
                  <li>4 audio recordings</li>
                  <li>
                    2 recordings: everyday conversations or short monologues
                  </li>
                  <li>
                    2 recordings: academic discussions, classroom topics or
              ...
              <div className="bg-yellow-200 rounded-2xl p-6 shadow-md border border-gray-100">
                ...
                <p className="text-black-600 text-sm mb-3">
                  <span className="font-semibold">Purpose:</span> Measures
                  spoken English skills through interviews, speeches and
                  discussions.
                </p>
                <p className="text-black-600 text-sm mb-3">
                  <span className="font-semibold">Time Duration:</span> 11-17
                  minutes
                </p>
                <ul className="text-black-600 text-sm list-disc list-inside space-y-1">
                  <li>Personal Interview: everyday or social conversation</li>
                  <li>
                    Speech Task: 1-2 minutes preparation and up to 2 minutes
                    speaking based on a visual prompt
                  </li>
                  <li>
                    Discussion: questions based on a previously given topic
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-yellow-200 rounded-2xl p-6 shadow-md border border-gray-100">
                ...
                <p className="text-black-600 text-sm mb-3">
                  <span className="font-semibold">Purpose:</span> Tests the
                  ability to express ideas clearly and logically in written
                  English.
                </p>
                <p className="text-black-600 text-sm mb-3">
                  <span className="font-semibold">Time Duration:</span> 50-60
                  minutes
                </p>
                <ul className="text-black-600 text-sm list-disc list-inside space-y-1">
                  <li>2 writing tasks</li>
                  <li>One short essay: 150 words</li>
                  <li>One detailed essay: 250 words</li>
                  <li>
                    Topics may be general, factual, argumentative or
                    opinion-based
                  </li>
                </ul>
              </div>
      ...
      <section className="py-20 bg-gradient-to-b from-white via-blue-50 to-white">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            TOEFL <span className="text-blue-600">Score & Validity</span>
          </h2>
          <div className="grid md:grid-cols-3 gap-8 mt-10">
            <div className="bg-yellow-200 rounded-2xl p-8 shadow-md">
              <div className="text-5xl font-bold text-blue-600 mb-2">0–120</div>
      ...
      {/* TOEFL PREPARATION TIPS SECTION */}
      <section className="py-20 bg-gradient-to-b from-white via-blue-50 to-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              TOEFL Exam <span className="text-blue-600">Preparation Tips</span>
            </h2>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Prepare for TOEFL exam with a structured plan and regular practice
            ...
            {[
              {
                ...
                desc: "Take a full-length mock test to understand exam pattern and timing.",
              },
              {
                title: "Analyze Your Score",
                desc: "Identify weak areas by analyzing your detailed score report.",
              },
              {
                title: "Create a Study Plan",
                desc: "Make a smart study plan focused on improvement areas.",
              },
              {
                title: "Timed Practice",
                desc: "Take timed practice tests to get the real exam experience.",
              },
              {
                title: "Section-wise Strategies",
                desc: "Use specific strategies for Reading, Listening, Speaking and Writing.",
              },
              {
                title: "Focus on Time Management",
                desc: "Practice managing time effectively for each section.",
              },
              {
                title: "Review Mistakes",
                desc: "Correct mistakes and review after every practice session.",
              },
              {
                title: "Track Progress",
                desc: "Monitor your progress and adjust your plan accordingly.",
              },
            ].map((tip, i) => (
              <div
                key={i}
                className="bg-yellow-200 rounded-xl p-5 shadow-md border border-gray-100 hover:shadow-lg transition"
              >
                <div className="w-10 h-10 bg-blue-300 rounded-full flex items-center justify-center mb-3">
                  <span className="text-black-600 font-bold">{i + 1}</span>
                </div>
          ...
          <div className="mt-10 text-center">
            <p className="text-gray-600">
              Preferred official ETS study materials and practice tests for best
              results.
            </p>
          </div>
        </div>
      ...
      {/* 5.TOEFL Online Live Training Features */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-center mb-6">
            <button className="bg-yellow-500 text-black px-6 py-3 rounded-full font-semibold shadow hover:scale-105 transition">
              TALK TO A TOEFL EXPERT
            </button>
          </div>

          {/* Heading */}
          <h2 className="text-center text-3xl md:text-4xl font-bold mb-12">
            TOEFL Online <span className="text-blue-600">Live Training</span>{" "}
            Features
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            {/* RIGHT CONTENT (Same Accordion Layout) */}
              ...
              >
                ...
                {active === "concept" && (
                  <ul className="mt-4 ml-12 space-y-2 text-gray-700 text-sm">
                    <li>✓ 16 hours of live online training</li>
                    <li>
                      ✓ 16 hours of live training for English Foundation
                      (Grammar & Writing)
                    </li>
                    <li>✓ Jamboree study material – 1 book</li>
            ...
            active === "speed"
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="font-semibold text-lg">Support & Guidance</h3>
                </div>

                {active === "speed" && (
                  <ul className="mt-4 ml-12 space-y-2 text-gray-700 text-sm">
                    <li>✓ Customized exam guidance</li>
                    <li>✓ Unlimited scheduled doubt-clearing sessions</li>
                    <li>✓ Class recordings available</li>
                    <li>✓ Course validity of 3 months</li>
                  </ul>
                )}
              </div>
            </div>
      ...
      {/* WHY CHOOSE TOEFL PREPARATION SECTION */}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-yellow-200 rounded-2xl p-6 shadow-md hover:shadow-xl transition-all duration-300 group-hover:-translate-y-1 border border-indigo-100">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Our proven methodology: Concept + Practice + Strategy ensures
            ...
            <div className="group relative">
              ...
              <div className="relative bg-yellow-200 rounded-2xl p-6 shadow-md hover:shadow-xl transition-all duration-300 group-hover:-translate-y-1 border border-purple-100">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Real exam simulation with our TOEFL-like test platform for
            ...
            <div className="group relative">
              <div className="absolute -inset-0.5 bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl blur opacity-0 group-hover:opacity-100 transition duration-500"></div>
              <div className="relative bg-yellow-200 rounded-2xl p-6 shadow-md hover:shadow-xl transition-all duration-300 group-hover:-translate-y-1 border border-orange-100">
                <div className="w-12 h-12 bg-gradient-to-r from-orange-500 to-red-600 rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition duration-300 mb-4">
                  <span className="text-white text-xl">❓</span>
                </div>
                <h4 className="text-xl font-bold text-gray-900 mb-2">
      ...
      {/* <section className="pb-10 pt-6 bg-slate-50 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10 text-center">
          <div className="mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-6 tracking-tight">What Happens <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">After the TOEFL?</span></h2>
            <p className="text-gray-500 max-w-2xl mx-auto text-lg leading-relaxed">Achieving your score is just the beginning. We guide you through every milestone of your university application journey.</p>
          </div>
            ...
            {[
              {
                ...
                a: "You can register for the TOEFL online, by phone, or via mail. For complete details, visit the official TOEFL website.",
              },
              {
                q: "How many times in a year is the TOEFL exam conducted?",
                a: "TOEFL is conducted multiple times throughout the year on specific dates. The schedule may vary by country, and you can check the official website for the complete timetable.",
              },
              {
                q: "How many times can I take the TOEFL?",
                a: "There is no limit to the number of attempts; however, you can take the test only once within a 12-day period.",
              },
              {
                q: "What is the validity of the TOEFL exam?",
                a: "TOEFL scores are valid for 2 years from the date of the test.",
              },
              {
                q: "How can I send my TOEFL score to colleges?",
                a: "Universities accept only official scores sent directly by ETS. You can send scores to up to four colleges free of cost from the time of registration until 24 hours before your test. After that, each additional score report costs $20.",
              },
              {
                q: "If I take the TOEFL multiple times, which score will universities consider?",
                a: "Most universities consider your highest (best) TOEFL score.",
              },
              {
                q: "What is the minimum TOEFL score required?",
                a: "For most universities, a score of 80+ is required for undergraduate and MS programs, while 100+ is typically expected for MBA and PhD courses. A score of around 100 is often preferred for students applying for scholarships or financial aid.",
              },
            ].map((item, index) => (
